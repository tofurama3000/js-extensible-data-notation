...
var grammar = {
    Lexer: undefined,
    ParserRules: [
        { name: 'Main', symbols: ['EDN'], postprocess: function (data) { return data[0]; } },
        { name: 'EDN', symbols: ['Exp'], postprocess: function (data) { return data[0]; } },
        { name: 'Exp$subexpression$1', symbols: ['ElementSpace'] },
        { name: 'Exp$subexpression$1', symbols: ['ElementNoSpace'] },
        { name: 'Exp', symbols: ['Exp$subexpression$1'], postprocess: function (data) { return [].concat.apply([], data[0]); } },
        { name: '_Exp', symbols: ['__exp'] },
        { name: '_Exp', symbols: ['__char'], postprocess: function (data) { return data[0]; } },
        { name: '__exp', symbols: ['_', 'Exp'], postprocess: function (data) { return data[1]; } },
        ...
        },
        {
            ...
            postprocess: function (data) { return [].concat.apply([], [data[0]].concat(data[1] ? [].concat.apply([], data[1]) : [])); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return [].concat.apply([], [data[0][0]].concat(data[1] ? [].concat.apply([], data[1]) : [])); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return [data[0]].concat(data[1] ? data[1][1] : []); }
        },
        ...
        { name: 'Element', symbols: ['Element$subexpression$1'], postprocess: function (data) { return data[0][0]; } },
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'vector', data: data[2] ? data[2][0] : [] }); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'list', data: data[2] ? data[2][0] : [] }); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'map', data: data[2] ? data[2][0] : [] }); }
        },
        {
            name: 'Set$string$1',
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'set', data: data[2] ? data[2][0] : [] }); }
        },
        {
            name: 'Tag',
            symbols: [{ literal: '#' }, 'Symbol', '_', 'Element'],
            postprocess: function (data, _l, reject) {
                if (data[1].data[0] === '_')
                    return reject;
        ...
        },
        {
            ...
            postprocess: function () { return ({ type: 'discard' }); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'string', data: data[1].join('') }); }
        },
        ...
        { name: 'string_char', symbols: ['backslash_unicode'], postprocess: id },
        {
            name: 'backslash',
            symbols: [{ literal: '\\' }, /["trn\\]/],
            postprocess: function (data) { return data.join(''); }
        },
        {
            name: 'backslash_unicode',
            symbols: [{ literal: '\\' }, 'unicode'],
            postprocess: function (data) { return data[1]; }
        },
        { name: 'Reserved$subexpression$1', symbols: ['boolean'] },
        { name: 'Reserved$subexpression$1', symbols: ['nil'] },
        { name: 'Reserved', symbols: ['Reserved$subexpression$1'], postprocess: function (data) { return data[0][0]; } },
        { name: 'boolean$subexpression$1', symbols: ['true'] },
        { name: 'boolean$subexpression$1', symbols: ['false'] },
        { name: 'boolean', symbols: ['boolean$subexpression$1'], postprocess: function (data) { return data[0][0]; } },
        {
            name: 'true$string$1',
        ...
        { name: 'true', symbols: ['true$string$1'], postprocess: function () { return ({ type: 'bool', data: true }); } },
        {
            name: 'false$string$1',
            symbols: [
                { literal: 'f' },
        ...
        },
        {
            ...
            postprocess: function () { return ({ type: 'bool', data: false }); }
        },
        {
            name: 'nil$string$1',
        ...
        },
        {
            ...
            postprocess: function (data) { return data[0] + (data[1] ? data[1].join('') : ''); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return data[0] + data[1].join(''); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return data[0] + (data[1] ? data[1][0] + data[1][1].join('') : ''); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return data[0] + data[1].join('') + (data[2] ? data[2].join('') : ''); }
        },
        { name: 'symbol_start', symbols: ['letter'] },
        { name: 'symbol_start', symbols: [/[*~_!?$%&=<>]/], postprocess: function (data) { return data[0]; } },
        { name: 'symbol_mid', symbols: ['letter'] },
        { name: 'symbol_mid', symbols: ['digit'] },
        { name: 'symbol_mid', symbols: [/[.*\!\-+_?$%&=<>:#]/], postprocess: function (data) { return data[0]; } },
        ...
        { name: 'symbol_second_special', symbols: [/[\-+.:#]/], postprocess: function (data) { return data[0]; } },
        {
            name: 'Keyword',
            symbols: [{ literal: ':' }, 'Symbol'],
            postprocess: function (data) { return ({ type: 'keyword', data: ':' + data[1].data }); }
        },
        {
            name: 'Character',
            symbols: [{ literal: '\\' }, 'char'],
            postprocess: function (data) { return ({ type: 'char', data: data[1][0] }); }
        },
        { name: 'char', symbols: [/[^ \t\r\n]/] },
        {
            name: 'char$string$1',
        ...
        { name: 'char', symbols: ['unicode'], postprocess: function (data) { return data[0]; } },
        { name: 'Number', symbols: ['Integer'] },
        { name: 'Number', symbols: ['Float'], postprocess: function (data) { return data[0]; } },
        {
            name: 'Float',
            symbols: ['float'],
            postprocess: function (data) { return ({ type: 'double', data: data[0][0], arbitrary: !!data[0][1] }); }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return ({ type: 'int', data: data[0][0], arbitrary: !!data[1] }); }
        },
        {
            name: 'float',
            symbols: ['int', { literal: 'M' }],
            postprocess: function (data) { return [data.slice(0, 1).join(''), data[1]]; }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return [data.slice(0, 2).join(''), data[2]]; }
        },
        ...
        },
        {
            ...
            postprocess: function (data) { return [data.slice(0, 3).join(''), data[2]]; }
        },
        ...
        { name: 'exp', symbols: ['ex', 'digits'], postprocess: function (data) { return data.join(''); } },
        ...
        },
        {
            ...
            postprocess: function (data) { return 'e' + (data[1] || '+'); }
        },
        ...
        { name: 'int_no_prefix', symbols: [{ literal: '0' }], postprocess: function (data) { return data.join(''); } },
        ...
        { name: 'oneToNine', symbols: [/[1-9]/], postprocess: function (data) { return data.join(''); } },
        {
            name: 'MapElem',
            symbols: ['mapKey', 'mapValue'],
            postprocess: function (data) { return [[data[0][0], data[1][0]]].concat(data[1].slice(1)); }
        },
        { name: 'mapKey$subexpression$1', symbols: ['mapKeySpace'] },
        { name: 'mapKey$subexpression$1', symbols: ['mapKeyNoSpace'] },
        { name: 'mapKey', symbols: ['mapKey$subexpression$1'], postprocess: function (data) { return data[0]; } },
        { name: 'mapValue$subexpression$1', symbols: ['mapValueSpace'] },
        { name: 'mapValue$subexpression$1', symbols: ['mapValueNoSpace'] },
        { name: 'mapValue', symbols: ['mapValue$subexpression$1'], postprocess: function (data) { return data[0][0]; } },
        ...
        },
        {
            ...
            postprocess: function (data) { return [data[1]].concat(data[2] ? data[2][1] : []); }
        },
        ...
        { name: 'mapElementNoSpace$subexpression$1', symbols: ['Set'] },
        {
            ...
            postprocess: function (data) { return data[0][0]; }
        },
        ...
        { name: 'mapElementSpace$subexpression$1', symbols: ['Tag'] },
        {
            ...
            postprocess: function (data) { return [].concat.apply([], [data[0][0]])[0]; }
        },
        { name: 'hexDigit', symbols: [/[a-fA-F0-9]/], postprocess: function (data) { return data[0]; } },
        {
            name: 'unicode',
            symbols: [{ literal: 'u' }, 'hexDigit', 'hexDigit', 'hexDigit', 'hexDigit'],
            postprocess: function (data) { return String.fromCharCode(parseInt(data.slice(1).join(''), 16)); }
        },
        { name: '_', symbols: ['space'], postprocess: function (data) { return data[0]; } },
        ...
        { name: 'space', symbols: ['space$ebnf$1'], postprocess: function (data) { return data[0].join(''); } },
        ...
        { name: 'digits', symbols: ['digits$ebnf$1'], postprocess: function (data) { return data[0].join(''); } },
        { name: 'digit', symbols: [/[0-9]/], postprocess: function (data) { return data[0]; } },
        { name: 'letter', symbols: [/[a-zA-Z]/], postprocess: function (data) { return data[0]; } }
    ],
    ParserStart: 'Main'
};
// Do the parsing
